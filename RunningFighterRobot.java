 ...
 */
public class RunningFighterRobot extends FighterRobot {
	
	//Constants
	private final int NUMPLAYERS = BattleManager.NUM_PLAYERS;
	private static final int ATTACK = 1;
	private static final int DEFENCE = 3;
	private final static int NUMMOVES = 6;
	 ...
	 */
	public RunningFighterRobot(City c, int a, int s, Direction d, int id, int MAX_HEALTH) {
